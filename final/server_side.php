<!DOCTYPE html>
<!--server_side.php, purpose of document is Giphy Mirror Final for ACSG-540-01 class at Saint Xavier University
Created by: Greg Cudzich on 2021-11-26 -->
<html lang="en">
<head>
    <meta charset="utf-8" />
    ...
    <body>
        ...
        //$q = (string)$_POST["keyWord"]; // string | Search query term or prhase.
        $q = "cheeseburgers";
